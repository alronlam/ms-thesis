...
def construct_text_class_arrays_from_txt():
...
x, y = construct_text_class_arrays_from_txt()
# x,y = construct_text_class_arrays_from_tsv('D:/DLSU/Masters/MS Thesis/data-2016/Context-Based_Tweets/test')
